  ...
  return (
    <div className=" flex flex-col space-y-3">
      <div className="flex flex-col sm:flex-row  sm:space-x-7">
        <div className="border p-0.5 rounded-md border-black w-full">
          <div className="w-full  h-72" style={styles.saturation}>
            <Saturation
              style={{
                circle: {
                  height: "8px",
        ...
        <div className="flex space-x-2 sm:mt-0 mt-5 sm:space-x-7">
